        ...
        jb_submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(jtf_email.getText().equals("") || jtf_firstName.getText().equals("") || jtf_lastName.getText().equals("") || jpf_password.getPassword().equals("") || jpf_confirmPassword.getPassword().equals(""))
                    ...
                    //System.out.println(registerMessage.getContent().getClass().getFields());
                    ...
                    //in case of the registeration success
                    if(Response.getType().equals(Message.SIGN_UP_SUCCESS)){
                        ...
                        new JOptionPane().showMessageDialog(RegisterFrame.this, "You Are Welcome , Thank You");
                        RegisterFrame.this.setVisible(false);
                        //RegisterFrame.this.clientProject.signInFrame.setVisible(true);
                        
                        RegisterFrame.this.clientProject.mainFrame.setVisible(true);
                        new JOptionPane().showMessageDialog(RegisterFrame.this, "You Must Sign Out To Complete Your Registeration");
                    }
...
//           jtf_firstName.getText();
//           jtf_lastName.getText();
//           jtf_email.getText();
//           jpf_password.getText();
//           jpf_confirmPassword.getText();
